  ...
  return (
    <>
      <footer className="bg-gray-800 text-white text-center p-7">
        <div className='w-full h-35 bg-gray-900 grid grid-cols-3 p-5'>

          {/* Call us*/}
          
          <div className='  flex justify-center items-center flex-col '>
            <h1 className='text-3xl mb-4 '>Call Us On :</h1>
          ...
          <div className='  flex justify-center items-center flex-col '>
            <h1 className='text-3xl mb-4 '>Opening Hours :</h1>
          ...
          <div className='  flex justify-center items-center flex-col '>
            <h1 className='text-3xl mb-4 '> Email Us :</h1>
